...
import { LicenceTableColumns } from '../../constants/licences-table-columns.constant';


@Component({
  selector: 'app-licence-search',
  templateUrl: './licence-search.component.html',
  styleUrls: ['./licence-search.component.scss']
})
export class LicenceSearchComponent extends AdvancedSearchBasePageComponent<PageResponse<Licence>> {
  opUnitType: any;
  opStatus: any;
  ...
  ): Observable<PageResponse<Licence>> {
    return this.licenceService.advancedSearch(criteria, sortCriteria);
  }
  ...
  onEditClick(licence: Licence): void {
    this.router.navigate([licence.id], {
