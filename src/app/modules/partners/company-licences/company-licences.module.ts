...
import { CompanyLicencesDeleteDialogComponent } from './components/company-licences-delete-dialog/company-licences-delete-dialog.component';
...
@NgModule({
  declarations: [CompanyLicencesSearchComponent, CompanyLicencesCreationDialogComponent, CompanyLicencesDeleteDialogComponent, CompanyLicencesSendEmailDialogComponent, CompanyLicencesUploadDialogComponent],
